...
let SendSmsPageModule = class SendSmsPageModule {
};
...
let SendSmsPage = class SendSmsPage {
    constructor(sms) {
        this.sms = sms;
    }
    ngOnInit() {
...
//# sourceMappingURL=send-sms-send-sms-module-es2015.js.map