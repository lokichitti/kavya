...
let RegisterPage = class RegisterPage {
    constructor(formBuilder, router, angularFireAuth) {
    ...
    onSubmit(values) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            console.log(values);
            try {
                const result = yield this.angularFireAuth.auth.createUserWithEmailAndPassword(values.email, values.matching_passwords.password);
                console.log(result);
            }
            catch (e) {
                console.error(e);
