...
var AuthService = /** @class */ (function () {
    function AuthService(afAuth, firestore, loadingCtrl, router, alertCtrl) {
        this.afAuth = afAuth;
    ...
    AuthService.prototype.signInWithPhoneNumber = function (phoneNumber, appVerifier) {
        var _this = this;
        this.afAuth.auth.signInWithPhoneNumber(phoneNumber, appVerifier)
            .then(function (confirmationResult) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var prompt;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
