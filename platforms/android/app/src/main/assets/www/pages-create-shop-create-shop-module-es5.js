...
var CreateShopPageModule = /** @class */ (function () {
...
var CreateShopPage = /** @class */ (function () {
    function CreateShopPage(formBuilder, router, authService, firebaseAuthentication, alertCtrl, toastCtrl, alert, storage) {
    ...
    CreateShopPage.prototype.ngOnInit = function () {
        this.countries = [
    ...
    CreateShopPage.prototype.createMyShop = function (shopDetails) {
    ...
    CreateShopPage.prototype.locateMyShop = function () {
    };
    CreateShopPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-create-shop-create-shop-module-es5.js.map