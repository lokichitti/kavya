...
PhoneValidator.validCountryPhone = (countryControl) => {
    ...
    return (phoneControl) => {
        ...
        if (phoneControl.value !== "") {
            try {
                const phoneUtil = google_libphonenumber__WEBPACK_IMPORTED_MODULE_3___default.a.PhoneNumberUtil.getInstance();
...
let RegisterPage = class RegisterPage {
    constructor(formBuilder, router, firebaseAuthentication) {
...
//# sourceMappingURL=default~register-register-module~sign-in-sign-in-module-es2015.js.map