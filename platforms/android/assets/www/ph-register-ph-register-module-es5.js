...
var PhRegisterPageModule = /** @class */ (function () {
    function PhRegisterPageModule() {
    }
...
var PhRegisterPage = /** @class */ (function () {
    function PhRegisterPage(formBuilder, router, angularFireAuth, angularFireDatabase) {
    ...
    PhRegisterPage.prototype.ngOnInit = function () {
    ...
    PhRegisterPage.prototype.createProfile = function (values) {
        /*this.angularFireAuth.authState.subscribe(auth=>{
          this.angularFireDatabase.list(`profile/${auth.uid}`).push
        });*/
    };
    PhRegisterPage.prototype.getOTP = function (values) {
    ...
    PhRegisterPage.prototype.verify = function () {
    ...
    PhRegisterPage.ctorParameters = function () { return [
...
//# sourceMappingURL=ph-register-ph-register-module-es5.js.map