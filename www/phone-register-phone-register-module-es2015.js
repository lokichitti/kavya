...
let PhoneRegisterPage = class PhoneRegisterPage {
    ...
    getOTP1(values) {
        ...
        self.firebaseAuthentication.verifyPhoneNumber("+918073990063", 30000).then((credential) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            self.verificationId1 = credential.verificationId;
